...
I predict based on the linear model that the high temperature Monday will be 84.8 degrees Fahrenheit with a prediction interval of `r round(pred.w84[2], 2)` and `r round(pred.w84[3], 2)` degrees.
...
```{r Normality_Plots, message=FALSE, warning=FALSE}
