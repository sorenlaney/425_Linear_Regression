...
```{r load_data, echo=FALSE, results='hide', include=FALSE}
# Use this R-Chunk to import all your datasets!

df <- read_xlsx("/Users/soren.laney/Desktop/Fall Semester 2022/Math 425 Applied Linear Regression/Analysis/Predicting the Weather/Data/Predict_Weather_Data.xlsx") %>% na.omit()
...
```{r tidy_data, results='hide', include=FALSE}
...
```{r plot_data_1, echo=FALSE, results='hide', include=FALSE}
# Use this R-Chunk to plot & visualize your data!

# temp-lag is really temp future
weather.lm <- lm(Temp_lag ~ Temp, data=df)
summary(weather.lm)
...
```{r SSTO_1, message=FALSE, warning=FALSE}
...
```{r Residual MSE & Residual Standard Error}
# Use this R-Chunk to import all your datasets!
